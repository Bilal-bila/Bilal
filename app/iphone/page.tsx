...
import { ArrowLeft, Apple, MessageCircle, Youtube, Music2 } from "lucide-react"
...
export default function IPhonePage() {
  ...
  return (
    <main className="min-h-screen bg-background px-4 py-8">
      <div className="fixed inset-0 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-slate-500/20 via-background to-background pointer-events-none" />
      ...
      <div className="relative z-10 max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-gradient-to-br from-slate-400/20 to-slate-500/5 border border-slate-400/30 mb-4">
            <Apple className="w-10 h-10 text-slate-300" />
          </div>
          <h1 className="text-3xl md:text-5xl font-bold bg-gradient-to-r from-slate-300 via-white to-slate-300 bg-clip-text text-transparent">
            Modificacion iPhone
          </h1>
        ...
        <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
          ...
          {/* YouTube Link */}
          <a 
            href="https://youtu.be/u-fxzO2EVm8?si=gAIk_QqHPwGnuD3u"
            target="_blank"
            rel="noopener noreferrer"
            onClick={playSound}
            className="group relative block"
